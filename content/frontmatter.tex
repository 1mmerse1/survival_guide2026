...
\begin{textblock}{.45}(.5,.82)
    \begin{center}
        \IfFileExists{assets/dlsin.png}{\includegraphics[width=.45\paperwidth]{assets/dlsin}}{}
    \end{center}
\end{textblock}

\begin{textblock}{.4}(.05,.65)
    \begin{center}
        \IfFileExists{assets/arccos.png}{\includegraphics[width=.4\paperwidth]{assets/arccos}}{}
    \end{center}
\end{textblock}
